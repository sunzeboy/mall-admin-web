<template>
  <!-- <div :style="{ height: clientHeight + 'px' }" class="aaa"> -->
      <div :style="backgroundDiv" >
        <!-- <img :src="login_bg" class="aaa"> -->
    <el-card class="login-form-layout">
      ...
      >
        <div style="text-align: center;">
          <img :src="login_icon" style="width: 80px; height: 80px; color: #409eff;">
        </div>
        <h2 class="login-title color-main">肠道益生菌分析系统</h2>
...
import login_bg from "@/assets/images/bg.png";
